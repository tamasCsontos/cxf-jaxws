...
@XmlSeeAlso({
    ...
    GetBranchStatesResponse.class,
    GetLanguagesResponse.class,
    GetFreeTimesResponse.class,
    AddBookingTicketResponse.class,
    RevokeBookingTicketResponse.class,
    AddTicketResponse.class,
    GetActiveTicketsResponse.class
})
public class ResponseBase {

    @XmlElementRef(name = "ErrorCode", namespace = "http://schemas.datacontract.org/2004/07/Aquis.QControl.ServerModules.PostaInterface", type = JAXBElement.class, required = false)
